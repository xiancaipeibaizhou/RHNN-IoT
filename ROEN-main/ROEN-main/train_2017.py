...
from untils import create_ip_mapping_2017, create_graph_data_2017, GraphDataset
...
train(model, train_dataloader, test_dataloader, optimizer, criterion, 150, 10, 'models/2017')
