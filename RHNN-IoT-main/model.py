...
class HyperConv(Module):
    def __init__(self, layers,dataset,emb_size=128):
...
class LineConv(Module):
    def __init__(self, layers,batch_size,emb_size=128):
...
class DHCN(Module):
    def __init__(self, adjacency, n_node,lr, layers,l2, beta,dataset,emb_size=100, batch_size=100):
        ...
        if dataset == 'TON-IoT':
            index_fliter = (values < 0.001).nonzero()
        ...
        self.pos_embedding = nn.Embedding(128, self.emb_size)
